...
const TRANSLATIONS = {
  zh: {
    ...
    'quiz.diagnostic.notice': '题目涵盖技术深度，部分题目偏难属正常现象。<strong>诊断的目的是找到你的起点</strong>，不是评判好坏。不会的题目直接跳过即可。',
  ...
  en: {
    ...
    'btn.quiz_dir':       'Quiz this direction (12 Q) →',
    ...
    'btn.quiz_topic':     'Quiz this direction (12 Q)',
    ...
    'quiz.diagnostic.notice': 'Some questions are intentionally challenging. <strong>The goal is to find your starting point</strong>, not to judge you. Skip freely.',
